...
class Servicos:
    ...
    def atualizar(cls, obj):
        ...
        if found:
            ...
            raise ValueError(f"Serviço com ID {obj.get_id()} não encontrado para atualização.")
    ...
    def excluir(cls, obj):
        ...
        if len(cls.objetos) < original_len:
            ...
            raise ValueError(f"Serviço com ID {obj.get_id()} não encontrado para exclusão.")
