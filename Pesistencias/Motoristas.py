import json
import os
from  Entidades.Motorista import Motorista
import streamlit as st
class Motoristas:
    objetos = []

    FILE_PATH = 'data/motoristas.json'
    ...
    def atualizar(cls, obj):
        ...
        if found:
            ...
            raise ValueError(f"Motorista com ID {obj.get_id()} não encontrado para atualização.")
    ...
    def excluir(cls, obj):
        ...
        if len(cls.objetos) < original_len:
            ...
            raise ValueError(f"Motorista com ID {obj.get_id()} não encontrado para exclusão.")
